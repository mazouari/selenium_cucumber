...
public class AuthentificationMultiUsersPage extends BasePage {
	...
	@FindBy(how = How.XPATH, using = "/html[1]/body[1]/div[3]/nav[1]/div[1]/ul[1]/li[3]/a[1]") 
	private static WebElement btnLogout;

	public AuthentificationMultiUsersPage() {
